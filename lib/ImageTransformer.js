...
var CropImageTransformation = require('./CropImageTransformation.js')
var StretchImageTransformation = require('./StretchImageTransformation.js')
var FitImageTransformation = require('./FitImageTransformation.js')
 ...
 * @param {ImageTransformation[]} transformations - The transformations to apply. Includes {@link CropImageTransformation}, {@link StretchImageTransformation} and {@link FitImageTransformation}.
      ...
      if (cbExists) {
        ...
        _.each(transformations, function (transformation) {
          if (transformation && transformation.type === 'crop') {
            processors.push(new CropImageTransformation(transformation.options))
          }
          if (transformation && transformation.type === 'stretch') {
            processors.push(new StretchImageTransformation(transformation.options))
          }
          if (transformation && transformation.type === 'fit') {
            processors.push(new FitImageTransformation(transformation.options))
          }
        })
        ...
        var processTransformation = function () {
          ...
          if (transformation) {
            ...
            if (transformation && transformation.type === 'crop') {
              processor = new CropImageTransformation(transformation.options)
            }
            if (transformation && transformation.type === 'stretch') {
              processor = new StretchImageTransformation(transformation.options)
            }
            if (transformation && transformation.type === 'fit') {
              processor = new FitImageTransformation(transformation.options)
            }
